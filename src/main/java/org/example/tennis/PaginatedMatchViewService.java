...
public class PaginatedMatchViewService {
    ...
    PaginatedMatchViewService(SessionFactory sessionFactory) {
    ...
    public MatchViewDto getPage(String page, String playerNameFilter) {
