...
public class MatchesServlet extends HttpServlet {
    ...
    private final MatchPageViewService matchPageViewService = new MatchPageViewService(sessionFactory);
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        MatchPageViewDto matchPage = matchPageViewService.getPage(page, playerNameFilter);
